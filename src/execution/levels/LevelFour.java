...
public class LevelFour implements LevelInformation {
    ...
    private static final double ROW_HEIGHT = Utils.getHeight() * 0.15;
    private static final int BLOCKS_IN_A_ROW = 15;
    private static final int NUMBER_OF_BLOCK_ROWS = 7;
    private static final double BLOCK_WIDTH = (Utils.getWidth() - 2
            * Utils.getBorderThickness()) / 15.0;
    private static final double BLOCK_HEIGHT = Utils.getHeight() / 22.2;
    private static final double INITIAL_BALLS_VELOCITY = 5;
    private static final int NUMBER_OF_BALLS_IN_GAME = 4;
