...
public class Ball implements Sprite {
     ...
     *
     * a geometry.Line object represented by the ball current position as the starting
     * point and the it's next position as it's ending point, based on it's
     * velocity.
     *
     * @return ball's trajectory represented as a geometry.Line object.
     */
    ...
    /**
     * will add the execution.animation.GameEnvironment object to ball's field.
     *
     * the ball must know about other objects in the game, that is why
     * we're adding execution.animation.GameEnvironment object to ball's field.
     *
     * @param environment the execution.animation.GameEnvironment object being added to the ball
     *                    fields.
     */
